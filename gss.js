...
case '*download_app*':
{
    ...
    try {
        ...
        await gss.sendMessage(m.chat, { document: fs.readFileSync(outputPath), mimetype: 'application/vnd.android.package-archive', filename: 'downloaded_app.apk', caption: 'hi ${pushname} here is your app' }, { quoted: m });
