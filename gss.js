...
case '*download_app*':
{
    ...
    try {
        ...
        await gss.sendMessage(m.chat, { document: fs.readFileSync(outputPath), mimetype: 'application/vnd.android.package-archive', fileName: 'downloaded_app.apk', caption: '' }, { quoted: m });
